 ...
 *
 * Provides the LCD panel factory entry expected by esp_board_manager so the
 * built-in ST7789 driver from ESP-IDF's esp_lcd component is used to back the
 * `display_lcd` device declared in board_devices.yaml.
 */
#include <string.h>
#include "esp_log.h"
#include "esp_check.h"
