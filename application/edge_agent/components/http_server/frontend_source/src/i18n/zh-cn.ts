...
export const zhCn: Dict = {
  ...
  navWebIm: '在线聊天',
  navLogo: 'Logo 自定义',
  navMeshtastic: 'Meshtastic 消息',

  meshTitle: 'Meshtastic 消息',
  meshDesc: '设备接收到的 Meshtastic 网络消息，已在本地持久化，并按 Meshtastic 格式展示。',
  meshRadio: '电台',
  meshConnected: '已连接',
  meshDisconnected: '未连接',
  meshMessages: '消息数',
  meshStore: '存储',
  meshPath: '路径',
  meshRefresh: '刷新',
  meshClear: '清空',
  meshAutoRefresh: '自动刷新（10秒）',
  meshLimit: '数量',
  meshColIndex: '#',
  meshColSender: '发送方',
  meshColFromNum: '节点号',
  ...
  meshLoading: '加载中…',
  meshEmpty: '暂无消息',
  meshClearConfirm: '确定清空全部已存储消息？此操作不可撤销。',
  meshClearOk: '消息已清空',
  meshClearFail: '清空消息失败',
  meshImPush: '推送到 IM',
  meshImNone: '无可用 IM 通道',
  meshImNotConfigured: '该 IM 通道尚未配置',
  meshImNotReady: '该 IM 通道尚未就绪',
  meshImNoTarget: '暂无最近会话',
  meshImUpdateFail: '更新 IM 推送失败',
  meshImCh_feishu: '飞书',
  meshImCh_qq: 'QQ',
