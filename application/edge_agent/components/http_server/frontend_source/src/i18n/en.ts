export const en = {
  ...
  navWebIm: 'Web Chat',
  navLogo: 'Logo',
  navMeshtastic: 'Meshtastic',

  meshTitle: 'Meshtastic Messages',
  meshDesc: 'Received Meshtastic mesh messages, persisted on the device and shown in Meshtastic format.',
  meshRadio: 'Radio',
  meshConnected: 'Connected',
  meshDisconnected: 'Disconnected',
  meshMessages: 'Messages',
  meshStore: 'Store',
  meshPath: 'Path',
  meshRefresh: 'Refresh',
  meshClear: 'Clear',
  meshAutoRefresh: 'Auto-refresh (10s)',
  meshLimit: 'Limit',
  meshColIndex: '#',
  meshColSender: 'Sender',
  meshColFromNum: 'FromNum',
  meshColPacketId: 'PacketId',
  meshColChannel: 'Channel',
  meshColMessage: 'Message',
  meshColTime: 'Time',
  meshColMore: 'More',
  meshLoading: 'Loading…',
  meshEmpty: 'No messages yet',
  meshClearConfirm: 'Clear all stored messages? This cannot be undone.',
  meshClearOk: 'Messages cleared',
  meshClearFail: 'Failed to clear messages',
  meshImPush: 'Push to IM',
  meshImNone: 'No IM channels',
  meshImNotConfigured: 'IM channel not configured',
  meshImNotReady: 'IM channel not ready',
  meshImNoTarget: 'no recent conversation yet',
  meshImUpdateFail: 'Failed to update IM push',
  meshImCh_feishu: 'Feishu',
  meshImCh_qq: 'QQ',
  meshImCh_telegram: 'Telegram',
  meshImCh_wechat: 'WeChat',
